...
import { Home, PieChart, PlusCircle, Calendar, User } from "lucide-react" // Changed Settings to Calendar
...
export function BottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 border-t bg-background pb-safe pt-2 px-6 z-50">
      <div className="flex justify-between items-center h-16 max-w-md mx-auto">
        ...
        {/* Swapped Budget for Today */}
        <Link href="/today" className={`flex flex-col items-center gap-1 ${isActive("/today")}`}>
